        ...
        <div class="container"> 
            ...
                        <tbody>
                           <c:forEach  var="o" items="${users}" >
                               <tr > 
                                   <td align="center"><a href="manage?action=edituser&amp;uid=${o.getUserId()}" class="btn btn-default"><em class="fa fa-pencil"></em></a> 
                                                      <a href="manage?action=deleteuser&amp;uid=${o.getUserId()}" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                   </td> 
                    ...
                    <ul class="pagination">
                        <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                            <li class="page-item ${loop.index == currentPage ? 'active' : ''}">
                                <a href="<c:url value='manage?action=manageuser'><c:param name='page' value='${loop.index}'/></c:url>" class="page-link">${loop.index}</a>
                                </li>
                        </c:forEach>
                    </ul>
                </div> 
